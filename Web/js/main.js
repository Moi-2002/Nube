...
// Ejemplo de función para añadir productos al carrito
function addToCart(product) {
    ...
    totalPrice.textContent = Number(totalPrice.textContent) + product.price;
}

// Puedes llamar a addToCart() con un objeto de producto cuando un usuario haga clic en "Añadir al carrito"
// Ejemplo: 
// addToCart({name: "Producto 1", price: 100});
